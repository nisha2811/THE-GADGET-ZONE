              ...
              <div class="p-5 mb-4">
                <div class="container-fluid py-5">
                    <h1 class="display-5 fw-bold">Admin Panel</h1>
                            <p class="col-md-8 fs-4">Admin can Add / Update Books. You can manage your orders from here</p>
                </div>
            </div>
        </div>
...
<div class=container-fluid>
    <div class=row>
        <div class=col-3 style="background-color:#ababff;">
            <a onclick="displayProductForm()" class="btn btn-primary" style="width:250px;">Add Product</a><br><br>
            <a onclick="displayallproducts()" class="btn btn-primary" style="width:250px;">Display All Products</a><br><br>

            <a href=# class="btn btn-primary" style="width:250px;">Update Stock</a><br><br>

            <a href=# class="btn btn-primary" style="width:250px;">Check Order</a><br><br>
