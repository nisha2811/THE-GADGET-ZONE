...
if($_SERVER['REQUEST_METHOD']=="POST")
{
 ...
 $res=pg_query($con,"select count(*) from customer where cuname='$un' and cpass='$ps'");

  $x=pg_fetch_array($res);
        ...
        <div class="col-4 shadow-lg p-3 mb-5 bg-white rounded" style="margin-top:200px; padding:60px;">
            <form action="login.php" method=post>
                ...
                <div class="form-group" style="margin-top:20px;">
                    <a href=register.php class="btn btn-warning">New User ? Register<a> 
